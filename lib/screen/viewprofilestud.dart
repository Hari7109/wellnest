    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          OptionTile(
            title: "Edit Details",
            subtitle: "Make changes to the student details",
            icon: Icons.edit,
            onTap: () {
          ...
          OptionTile(
            ...
            subtitle: "View the entire health assessment of the student",
          ...
          OptionTile(
            ...
            subtitle: "Delete the account of the student",
            icon: Icons.delete_forever,
            textColor: Colors.red,
            onTap: () {
              // Delete student profile logic
            },
          ),
